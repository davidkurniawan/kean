            ...
            <div class="col-12 mt-0 text-start content">
                ...
                <form class="form-floating mb-0">
                    <div class="col-md mb-2 history no-border box py-2 py-lg-4">
                        ...
                        <?php foreach ($transUser as $keyParent => $transParent): ?>
                            ...
                            <div class="col-12 col-lg-8 d-flex align-content-center flex-column">
                                <div class="d-flex align-content-center flex-row">
                                    ...
                                    <div class="d-flex align-content-center flex-column">
                                        <h4 class="order-1"><?php echo $transParent['date_created'] ?> <small class="badge info"><?php echo $transParent['nama_status_transaksi'] ?></small>
                                            <?php if($transParent['transaction_status'] == 1 && $transParent['payment_method'] == "xendit"){ ?> 
                                                <a href="<?php echo "https://checkout.xendit.co/web/".$transParent['id_xendit'] ?>" target="_blank" class="btn btn-info">Klik untuk pembayaran</a>
                                            <?php } else if ($transParent['transaction_status'] == 1 && $transParent['payment_method'] == "TF BCA-4882020111"){ ?>
                                                <a href="<?php echo BASEURL.'cart/paymentstatus/'.$transParent['transaction_id'] ?>" target="_blank" class="btn btn-info">Klik untuk pembayaran</a>
                                            <?php } ?>
                                            <?php if ($transParent['transaction_status'] == 6 && $transParent['payment_method'] == "TF BCA-4882020111"){ ?>
                                                <small class="badge warning">Pembayaran sedang dicek oleh Admin</small>
                                            <?php } ?>
                                        </h4>
                                ...
                                <div class="d-flex align-content-center flex-row">
                                    <div class="h-100">
                                        <table>
                                            ...
                                            <tr>
                                                <td>No Resi </td>
                                                <td>: <?php echo $transParent['nomer_resi'] ?></td>
                                            </tr>
                                            <tr>
                                                <td>Nama  </td>
                        ...
                        <?php foreach ($historyClaim as $key => $cpoin): ?>
                            <?php if ($cpoin['status_redeem_poin'] == 1): ?>
                        <div class="item p-4 mb-3 d-flex flex-wrap">
                            <div class="col-12 col-lg-8 d-flex align-content-center flex-column">
                                <div class="d-flex align-content-center flex-row">
                                    <div class="h-100">
