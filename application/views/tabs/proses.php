            ...
            <div class="col-12 mt-0 text-start content">
                ...
                <form class="form-floating mb-0">
                    <div class="col-md mb-2 history no-border box py-2 py-lg-4">
                        ...
                        <?php foreach ($proses as $keyParent => $transParent): ?>
                            ...
                            <div class="col-12 col-lg-8 d-flex align-content-center flex-column">
                                <div class="d-flex align-content-center flex-row">
                                    ...
                                    <div class="d-flex align-content-center flex-column">
                                        <h4 class="order-1"><?php echo $transParent['date_created'] ?> <small class="badge info"><?php echo $transParent['nama_status_transaksi'] ?></small> <small class="badge info"><?php echo $transParent['title_ekspedisi_status'] ?></small> <?php if($transParent['transaction_status'] == 1){ ?> <a href="<?php echo "https://checkout.xendit.co/web/".$transParent['id_xendit'] ?>" target="_blank" class="btn btn-info">Klik untuk pembayaran</a><?php } ?></h4>
                                ...
                                <div class="collapse" id="collapseItems<?php echo $keyParent ?>">
                                    ...
                                    <div class="d-flex align-content-center flex-row mt-4">
                                        ...
                                        <div class="d-flex align-content-center flex-column">
                                            <h4 class="order-1"><?php echo $transParent['date_created'] ?> <small class="badge info"><?php echo $transParent['title_ekspedisi_status'] ?></small></h4>
                        ...
                        <?php foreach ($historyClaim as $key => $cpoin): ?>
                            <?php if ($cpoin['status_redeem_poin'] == 2): ?>
                        <div class="item p-4 mb-3 d-flex flex-wrap">
                            <div class="col-12 col-lg-8 d-flex align-content-center flex-column">
                                <div class="d-flex align-content-center flex-row">
                                    <div class="h-100">
                                ...
                                <div class="d-flex align-content-center flex-row">
                                    <div class="h-100">
                                        <table>
                                            <tr>
                                                <td>No Resi </td>
                                                <td>: <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalHistoryPengiriman"><?php echo $cpoin['nomer_resi'] ?></button></td>
                                            </tr>
                                            <tr>
                                                <td>Nama  </td>
