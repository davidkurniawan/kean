...
<head>
    ...
    <title>Forget Password - Diary Official</title>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    <td class="content-block"
                                        ...
                                        valign="top">
                                        Atur ulang kata sandi Anda?Jika Anda meminta pengaturan ulang kata sandi untuk <?php echo $foo['email'] ?>, gunakan kode konfirmasi di bawah untuk menyelesaikan proses tersebut..
                                    </td>
                                </tr>
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    <td class="content-block"
                                ...
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    <td class="content-block" itemprop="handler" itemscope
                                        ...
                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                        valign="top">
                                        <h4 style="font-weight: 800;"><strong><?php echo $foo['kode_verifikasi'] ?></strong></h4>
                                    </td>
                                </tr>
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    <td class="content-block"
                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                        valign="top">
                                        &mdash; Anda mendapatkan banyak email pengaturan ulang kata sandi?Anda dapat mengubah pengaturan akun untuk meminta informasi pribadi agar dapat mengatur ulang kata sandi.
                                    </td>
                                </tr>
                            </table>
                        </td>
