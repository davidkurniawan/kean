        ...
        <div class="container p-0 p-xl-5 d-flex justify-content-center h-100">
            <div class="card align-self-center col-12 col-lg-6 p-5">
                ...
                <div class="card-body my-2 text-center">                    
                    ...
                    <p class="card-text mb-4">Please submit your New Password</p>
                    ...
                    <?php endif ?>
                    <form class="form-floating mb-0" method="POST" action="<?php echo BASEURL.'user/changepasswordAct' ?>">
                        <div class="col-md mb-2">
                            <div class="form-floating">
                                ...
                                <input type="hidden" value="<?php echo $userData['email'] ?>" name="email">
                                <input type="hidden" value="<?php echo $userData['kode_verifikasi'] ?>" name="kode_verifikasi">
                            </div>
                        </div>
