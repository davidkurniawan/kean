          ...
          <div class="col-lg-4">
            <div class="post-entry-1 lg">
              ...
              <div class="d-flex align-items-center author">
                <div class="photo"><img src="<?php echo ASSETS.'img/news/' ?>person-1.jpg" alt="" class="img-fluid"></div>
                <div class="name">
          ...
          <div class="col-md-9">
            ...
            <div class="d-lg-flex post-entry-2">
              <a href="single-post.html" class="me-4 thumbnail mb-4 mb-lg-0 d-inline-block">
                <img src="<?php echo ASSETS.'img/news/' ?>post-landscape-6.jpg" alt="" class="img-fluid">
              </a>
              <div>
                <div class="post-meta"><span class="date">Culture</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                ...
                <div class="d-flex align-items-center author">
                  <div class="photo"><img src="<?php echo ASSETS.'img/news/' ?>person-2.jpg" alt="" class="img-fluid"></div>
                  <div class="name">
          ...
          <div class="col-md-9 order-md-2">
            ...
            <div class="d-lg-flex post-entry-2">
              <a href="single-post.html" class="me-4 thumbnail d-inline-block mb-4 mb-lg-0">
                <img src="<?php echo ASSETS.'img/news/' ?>post-landscape-3.jpg" alt="" class="img-fluid">
              </a>
              <div>
                <div class="post-meta"><span class="date">Business</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                <h3><a href="single-post.html">What is the son of Football Coach John Gruden, Deuce Gruden doing Now?</a></h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio placeat exercitationem magni voluptates dolore. Tenetur fugiat voluptates quas, nobis error deserunt aliquam temporibus sapiente, laudantium dolorum itaque libero eos deleniti?</p>
                <div class="d-flex align-items-center author">
                  <div class="photo"><img src="<?php echo ASSETS.'img/news/' ?>person-4.jpg" alt="" class="img-fluid"></div>
                  <div class="name">
                    <h3 class="m-0 p-0">Wade Warren</h3>
                  </div>
                </div>
        ...
        <div class="row g-5">
          <div class="col-lg-4">
            <div class="post-entry-1 lg">
              ...
              <div class="d-flex align-items-center author">
                <div class="photo"><img src="<?php echo ASSETS.'img/news/' ?>person-7.jpg" alt="" class="img-fluid"></div>
                <div class="name">
          ...
          <div class="col-lg-8">
            <div class="row g-5">
              <div class="col-lg-4 border-start custom-border">
                ...
                <div class="post-entry-1">
                  <a href="single-post.html"><img src="<?php echo ASSETS.'img/news/' ?>post-landscape-4.jpg" alt="" class="img-fluid"></a>
