        ...
        <div class="d-flex justify-content-center align-content-between flex-wrap text-center px-1 px-md-4">
            ...
            <div class="col-12 col-lg-7 px-0 px-md-5 mt-5 mt-lg-0 text-start content">
                ...
                <form class="form-floating mb-0" action="<?php echo BASEURL.'user/daftar' ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="floatingAlamatRegistHome" name="selectAlamat" placeholder="Kecamatan/Kota/Provinsi/Kode Pos" required>
                    ...
                    <div class="col-md mb-2">
                        <div class="form-floating">
                            <input type="text" class="form-control"placeholder="provinsi" id="floatingProvinsiRegistHome" name="provinsi" required>
                            <label for="kecamatanFloatingAlamat">Provinsi</label>
                        </div>
                    </div>
                    <div class="col-md mb-2">
                        <div class="form-floating">
                            <input type="text" class="form-control" placeholder="kota" name="kota" id="floatKotaRegistHome" required>
                            <label for="kecamatanFloatingAlamat">Kota</label>
                        </div>
                    </div>
                    <div class="col-md mb-2">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="floatKecamatanRegistHome" placeholder="kecamatan" name="kecamatan" required>
                            <label for="kecamatanFloatingAlamat">Kecamatan</label>
                        </div>
                    </div>
                    <div class="col-md mb-2">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="floatKelurahanRegistHome" placeholder="Kelurahan" name="kelurahan" required>
                            <label for="kelurahanFloatingAlamat">Kelurahan</label>
                        </div>
                    </div>
                    <div class="col-md mb-2">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="floatingKodeposRegistHome" placeholder="kodepos" name="kodepos" required>
                            <label for="kodeposFloatingAlamat">Kode Pos</label>
                        </div>
                    </div>
                    <div class="col-md mb-2">
                        <div class="form-floating">
                            <input type="password" class="form-control passwordShowinputHome" placeholder="Password" id="passwordRegisterHome" name="password" required>
...
$(document).ready(function() {
    ...
    $( "#floatingAlamatRegistHome" ).keyup(function() {
    ...
    $(".absolute-select").on('click','.option-destination',function () {
        ...
        $("#floatingProvinsiRegistHome").val(provinsi);
        $("#floatKotaRegistHome").val(kota);
        $("#floatKecamatanRegistHome").val(kecamatan);
        $("#floatingKodeposRegistHome").val(kodepos);
...
<script type="text/javascript">
    function show() {
    var p = document.getElementById('passwordRegisterHome');
